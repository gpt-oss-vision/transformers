...
# 
# Based on the original GPT-OSS tokenization from Hugging Face & OpenAI's GPT-OSS.
...
"""Tokenization classes for GPT-OSS-Vision."""
...
PRETRAINED_VOCAB_FILES_MAP = {
    "AIGym/gpt_oss_vision_20B": {
        "vocab_file": "https://huggingface.co/AIGym/gpt_oss_vision_20B/resolve/main/vocab.json",
        "merges_file": "https://huggingface.co/AIGym/gpt_oss_vision_20B/resolve/main/merges.txt",
    },
}
...
class GPTOSSVisionTokenizer(PreTrainedTokenizer):
    """
    Construct a GPT-OSS-Vision tokenizer. Based on byte-level Byte-Pair-Encoding.
...
def bytes_to_unicode():
    ...
    This is a significant percentage of your normal, say, 32K bpe vocab. To avoid that, we want lookup
